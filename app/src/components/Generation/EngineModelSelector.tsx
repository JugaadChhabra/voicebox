...
const ENGINE_OPTIONS = [
  ...
  { value: 'indicf5', label: 'IndicF5 (Indic)', engine: 'indicf5' },
] as const;
...
const ENGINE_DESCRIPTIONS: Record<string, string> = {
  ...
  indicf5: '11 Indic languages, voice cloning',
};
...
const CLONING_ENGINES = new Set(['qwen', 'luxtts', 'chatterbox', 'chatterbox_turbo', 'tada', 'indicf5']);
