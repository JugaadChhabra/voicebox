...
class VoiceProfileCreate(BaseModel):
    ...
    language: str = Field(
        default="en", pattern="^(zh|en|ja|ko|de|fr|ru|pt|es|it|he|ar|da|el|fi|hi|ms|nl|no|pl|sv|sw|tr|as|bn|gu|kn|ml|mr|or|pa|ta|te)$"
    )
...
class GenerationRequest(BaseModel):
    ...
    language: str = Field(default="en", pattern="^(zh|en|ja|ko|de|fr|ru|pt|es|it|he|ar|da|el|fi|hi|ms|nl|no|pl|sv|sw|tr|as|bn|gu|kn|ml|mr|or|pa|ta|te)$")
...
class SpeakRequest(BaseModel):
    ...
    language: Optional[str] = Field(
        None,
        pattern="^(zh|en|ja|ko|de|fr|ru|pt|es|it|he|ar|da|el|fi|hi|ms|nl|no|pl|sv|sw|tr|as|bn|gu|kn|ml|mr|or|pa|ta|te)$",
    )
